...
var Application = /** @class */ (function () {
    ...
    Application.prototype.init = function (renderType) {
        return __awaiter(this, void 0, void 0, function () {
            var engineConfigPath, urlParams, engineConfig, loadSceneRtn;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, SceneManager.load(engineConfig.scenes[0])];
                    case 3:
                        loadSceneRtn = _a.sent();
                        if (renderType === 'webgl') {
    ...
    Application.prototype.mainLoop = function (time) {
        ...
        SystemManager.systems.forEach(function (system) {
            system.update();
        });
