...
var SceneManager = /** @class */ (function () {
    ...
    SceneManager.load = function (sceneName, baseUrl) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var scenePath, response, scene, tilesets;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        tilesets = [];
                        scene.tilesets.forEach(function (tilesetName, index) { return __awaiter(_this, void 0, void 0, function () {
                            var tilesetImage, tilesetPath;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
