export default class Mat4 {
    ...
    public static translate(m, tx, ty, tz) {
        return Mat4.multiply(m, Mat4.translation(tx, ty, tz));
    }
    
    public static xRotate(m, angleInRadians) {
        return Mat4.multiply(m, Mat4.xRotation(angleInRadians));
    }
    
    public static yRotate(m, angleInRadians) {
    ...
    public static projection(width, height, depth) {
