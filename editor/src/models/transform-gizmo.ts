...
export default class TransformGizmo {
    ...
    constructor(transform: Transform, context: CanvasRenderingContext2D) {
    ...
    draw(): void {
        ...
        // this.context.lineWidth = this.yAxis.width;
        // this.context.strokeStyle = '#DD5246';
        // this.context.moveTo(this.yAxis.x, this.yAxis.y);
